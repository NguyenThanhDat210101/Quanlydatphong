...
@section('mainAuth')
    <form action="{{ route('register.post')}}" method="POST" class="user" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <input type="text" class="form-control form-control-user" name="nameRegister" id="exampleInputEmail"
                placeholder="Name">
        ...
        <div class="form-group">
            <input type="text" class="form-control form-control-user" name="phoneRegister" id="exampleInputEmail"
                placeholder="Phone">
            <small class="text-danger form-text">
                @error('phoneRegister')
                    {{$message}}
        ...
        <div class="form-group">
            <input type="text" class="form-control form-control-user" name="cmndRegister" id="exampleInputEmail"
        ...
        <div class="form-group">
            <input type="email" class="form-control form-control-user" name="emailRegister" id="exampleInputEmail"
                placeholder="Email">
            <small class="text-danger form-text">
                @error('emailRegister')
                {{$message}}
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="password" class="form-control form-control-user"
                    id="exampleRepeatPassword" name="configPasswordRegister" placeholder="Repeat Password">
                <small class="text-danger form-text ">
